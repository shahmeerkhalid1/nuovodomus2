                    ...
                    <div className='container flex lg:flex-row flex-col justify-between relative z-10 '>
                        <div className='2xl:max-w-[637px] lg:max-w-[500px] w-full'>
                            ...
                            <ul className='mt-[35px]'>
                                ...
                                <li className='text-secondary-foreground flex items-center gap-[27px] mt-4'><RightArrow width={"35"} height={"22"} /> <span className='text-secondary-foreground text-2xl leading-160 font-bold'>Air Quality and Climate Control</span> </li>
                                <li className='text-secondary-foreground flex items-center gap-[27px] mt-4'><RightArrow width={"35"} height={"22"} /> <span className='text-secondary-foreground text-2xl leading-160 font-bold'>Medical Supplies</span> </li>
                                <li className='text-secondary-foreground flex items-center gap-[27px] mt-4'><RightArrow width={"35"} height={"22"} /> <span className='text-secondary-foreground text-2xl leading-160 font-bold'>Safety and Construction</span> </li>
                            </ul>
