                            ...
                            bannerData.map(({ id, banner_img, heading }) => {
                                return (
                                    <SwiperSlide key={id} className='relative'>
                                        <Image src={banner_img} loading='lazy'  placeholder='blur'   width={"auto"} height={"auto"} alt='bg image' className='h-full object-cover' />
                                    </SwiperSlide>
                                )
                            })
                        }
                    ...
                    bannerBottomContent.map(({ id, banner_img, title }) => {
                        return (
                            <div key={id} className='relative overflow-hidden after:contents-[""] after:absolute after:bottom-0 after:left-0 after:w-full after:h-full after:bg-overlay '>
                                <Image src={banner_img} loading='lazy'  placeholder='blur' blurDataURL={staticBluarDataUrl} alt='banner-bottom-bg' width={780} height={408} />
