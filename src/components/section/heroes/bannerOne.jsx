  ...
  const pagination = {
    ...
    renderBullet: function (index, className) {
      ...
      <span class='${className} flex leading-120'>
         <span class='inline-block mr-2 lg:text-5xl text-3xl font-extrabold text-transparent webkit-text-stroke-width-1 webkit-text-stroke-primary active-blut'>0${
           index + 1
         }</span>
         <span class='title md:text-lg text-sm font-semibold text-primary-foreground hidden sm:block sm:max-w-56 max-w-48'> ${
           data[index].title
         }</span>
      </span>`;
    },
                  ...
                  <div className="xl:pt-[230px] pt-[200px] pb-[250px]">
                    <div>
                      <h1 className="xl:text-[150px] lg:text-[130px] 2sm:text-[100px] sm:text-[70px] xm:text-[3.8rem] xm:leading-[1] text-5xl leading-[100%] font-extrabold relative">
                        ...
                        <svg
                          strokeWidth="2"
                          className="stroke-primary stroke-dasharray-1000 stroke-dashoffset-1000 animate-text-line-animation w-full 2sm:h-[200px] h-25"
                        >
        ...
        <div className="flex justify-between absolute right-0 bottom-0 z-40">
          ...
          <div className="flex flex-col sm:w-[90px] min-w-17.5 xl:h-[181px] h-[136px] ">
            <button
              ...
              className={cn(
                `bg-primary ${bg_muted} text-secondary-foreground flex justify-center items-center h-1/2 `
              )}
            >
              {" "}
            ...
            <button
              ...
              className={cn(
                `bg-secondary text-primary-foreground flex justify-center items-center h-1/2 rotate-180`
              )}
            >
              {" "}
              <RightArrow width={"35"} height={"22"} />{" "}
