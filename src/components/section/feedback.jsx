...
import feedback_bg from "@/assets/images/feedback-image-4.jpg"
...
const Feedback = () => {
  return (
    <section className='container py-20'>
      <div className='bg-cover bg-no-repeat bg-right-bottom lg:pt-[117px] pt-20 pb-[69px] lg:pl-[148px] pl-10 lg:pr-[133px] 2sm:pr-24 pr-10 flex md:flex-row flex-col justify-between md:items-end items-start' style={{ backgroundImage: `url(${feedback_bg.src})` }}>
