                ...
                <div className='flex flex-col justify-between h-[calc(100vh - 270px]'>
                                    ...
                                    return (
                                        <li key={index} className='flex items-center justify-between mb-[22px] last:mb-0'>
                                            <div className='flex items-center gap-6'>
                                                <Image src={product_img.src} loading='lazy' placeholder='blur' blurDataURL={staticBluarDataUrl} width={"106"} height={"126"} alt='shop img' />
                                                <div>
                    ...
                    <div className='mt-14'>
                        ...
                        <div className='mt-7 flex gap-[27px] items-center'>
                            <ButtonFill className={'px-7.5 py-2.5 w-full justify-center'}>
                            <Link href={"/cart"}>View Cart</Link>
                            </ButtonFill>
                            <ButtonFill className={'px-7.5 py-2.5 w-full justify-center after:bg-secondary text-primary-foreground'}>
