            ...
            <div className='container relative'>
                <div className={cn(`xl:-mt-52 -mt-16 xl:ml-12.5 lg:ml-9 md:ml-7 ml-3 after:contents-[""] after:absolute after:left-[12px] after:top-0 after:w-[1px] after:h-full after:bg-primary`)}>
                    ...
                    <div className='flex md:flex-row flex-col justify-between md:items-center'>
                        {sectionDesc && <h5 className={cn(`text-primary-foreground lg:text-[35px] sm:text-3xl text-2xl font-semibold mt-4 ${subTitleFullWidth ? 'max-w-full':'max-w-[690px]'}  md:mb-0 mb-7 !leading-160 ${text_muted}`)}>{sectionDesc}</h5>}
                        {
