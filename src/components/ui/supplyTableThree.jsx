  ...
  const defaultData = [
    {
      ...
      value:
        "Approx. 40-45 kWh per day (e.g., ~10 kW PV system produces ~16,000 kWh/year approximately 44 kWh/day)",
    },
    {
      aspect: "Battery Storage (30 Days)",
      value:
        "Approx. 1,000 kWh capacity (to ensure 30-day autonomy with a daily consumption of ~30-35 kWh)",
    },
    {
    ...
    <div className="w-full text-white">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start gap-4 backdrop-blur-sm">
        {tableData.map((item, index) => (
          <div
            key={index}
            className="w-full lg:w-auto lg:flex-1 p-4 bg-gray-800/50 rounded-lg border border-white/30 hover:bg-gray-700/50 transition-all duration-300"
          >
