    ...
    return (
        ...
        <div className='bg-white px-[9px] pt-[9px] pb-[15px] hover:shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] transition-all duration-500'>
            <div className='mb-[9px] grid grid-cols-[70%_auto] gap-[9px]'>
                <Image src={project_img_2} loading='lazy'  placeholder='blur' blurDataURL={staticBluarDataUrl} alt='project-img-2' className='h-full w-auto' />
                <div className='gap-[9px] flex flex-col'>
                    <Image src={project_img_2} loading='lazy'  placeholder='blur' blurDataURL={staticBluarDataUrl} alt='project-img-2' className='h-full w-auto' />
                    <Image src={project_img_3} loading='lazy'  placeholder='blur' blurDataURL={staticBluarDataUrl} alt='project-img-2' className='h-full w-auto' />
                    <Image src={project_img_4} loading='lazy'  placeholder='blur' blurDataURL={staticBluarDataUrl} alt='project-img-2' className='h-full w-auto' />
                </div>
            </div>
