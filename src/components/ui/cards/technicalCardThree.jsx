        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="w-full max-w-[900px] h-[120px] xm:h-[140px] sm:h-[220px] md:h-[290px] lg:h-[600px] relative">
            ...
            >
              ...
              {technical_figure_video ? <video
                autoPlay
                loop
                muted
                playsInline
                className="rounded-lg shadow-lg h-full w-full object-cover"
                aria-label="Looping video demonstrating smart home technical features"
                preload="metadata"
              >
                <source src={technical_figure_video} type="video/mp4" />
                <source src={`${technical_figure_video.toString().replace(".mp4", ".webm")}`} type="video/webm" />
                <img
                    src={technical_figure_img.src}
                    alt="smart-home-video-fallback"
                    className="rounded-lg shadow-lg h-full w-full object-cover"
                />
              </video> : <Image
