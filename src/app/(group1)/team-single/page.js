          ...
          <div className='grid xl:grid-cols-[auto_538px] lg:grid-cols-[auto_350px] md:grid-cols-[auto_400px] 2xl:gap-[132px] gap-16 items-start'>
            <div>
              <div className='mb-12.5'>
                ...
                <p>Russell Otten, the Interior Alchemist at NuovoDomus, adds a touch of magic to spaces. With over a decade of experience, Russell blends artistic flair with a deep understanding of client aspirations.</p>
              </div>
              ...
              <div className='pt-20'>
                ...
                <ul>
                  <li>
                    ...
                    <p className='mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10'>Russell's design philosop NuovoDomus revolves around capturing the essence of each client's persionality and translating it into a space that feels uniquely theirs.</p>
                  </li>
                  <li className='pt-7.5'>
              ...
              <div className='pt-20'>
                ...
                <ul>
                  <li>
                    ...
                    <p className='mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10'>Russell holds a Master's in Interior of the Design from NuovoDomus University of Belgium.</p>
                  </li>
                  <li className='pt-7.5'>
              ...
              <div className='pt-20'>
                ...
                <ul>
                  <li>
                    ...
                    <p className='mt-2.5 xl:ml-[113px] 2sm:ml-14 ml-10'>Russell Otten's work at NuovoDomus has been feeatured in Design Excellence Magazine, earning him the Interior Alchemist title.</p>
                  </li>
              ...
              <div className='pt-20'>
                ...
                <ul>
                  <li className='flex items-center mb-3'>
                    ...
                    <Link href={"mailto:russell@NuovoDomus.com"} className='hover-underline' ><span>russell@NuovoDomus.com</span></Link>
                  </li>
                  <li className='flex items-center mb-3'>
            ...
            <div className='sticky top-16'>
              <Image src={team_img} loading='lazy'  placeholder='blur'    alt='Russell Otten' className='w-full' />
